...
L.OWM = L.TileLayer.extend({
  options: {
    appId:
      'GET_YOUR_OWN_APPID' /* pass your own AppId as parameter when creating the layer. Get your own AppId at https://www.openweathermap.org/appid */,
    baseUrl:
      'https://{s}.tile.openweathermap.org/map/{layername}/{z}/{x}/{y}.png',
    maxZoom: 18,
    showLegend: true,
...
L.OWM.Current = L.Layer.extend({
  ...
  initialize: function (options) {
    ...
    this._map = null;
    this._urlTemplate =
      'https://api.openweathermap.org/data/2.5/box/{type}?{appId}cnt=300&format=json&units=metric&bbox={minlon},{minlat},{maxlon},{maxlat},10';
    this._directions = [
      'N',
      'NNE',
      'NE',
